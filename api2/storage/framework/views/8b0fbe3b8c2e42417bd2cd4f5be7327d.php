...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['conflicts' => [], 'conflictsLocations' => getConflictsLocations()]));
...
foreach (array_filter((['conflicts' => [], 'conflictsLocations' => getConflictsLocations()]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?= app('\Spatie\BladeJavaScript\Renderer')->render(['conflicts' => $conflicts, 'conflictsLocations' => $conflictsLocations]); ?>
...
<?php endif; ?>
    ...
    <div class="filters">
        ...
        <select id="countryFilter" onchange="filterConflicts()">
            ...
            <?php $__currentLoopData = $conflictsLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($loop->index); ?>"><?php echo e($location); ?></option>
...
<div class="login-prompt" style="display: flex; align-items: center; margin-bottom: 20px;">
    ...
    <script src="<?php echo e(asset('js/konflikty.js')); ?>"></script>
    </body>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\WronM\Documents\resource-presenter\api2\resources\views/components/conflicts.blade.php ENDPATH**/ ?>